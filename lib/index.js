...
function (_EventEmitter) {
  ...
  _createClass(Adapter, [{
    ...
    value: function connect(cb) {
      this.kafkaClient = new KafkaClient(_objectSpread({}, kafkaOptions, {}, this.options.client));
      this.producer = new Producer(this.kafkaClient, _objectSpread({}, producerOptions, {}, this.options.producer));
    ...
    value: function subscribe(topic, options, cb) {
      this.consumerGroup = new ConsumerGroup(_objectSpread({}, consumerGroupOptions, {}, this.options.consumerGroup), topic);
